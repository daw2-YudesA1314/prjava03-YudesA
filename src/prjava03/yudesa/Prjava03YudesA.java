...
public class Prjava03YudesA extends Frame 
   ...
   public Prjava03YudesA () { 
      ...
      setTitle("Nova finestra prjava03-YudesA");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava03YudesA();  // Let the construct do the job 
   } 
